...
exports.getErrorMessageServer = (error) => '<li class="list-group-item list-group-item-danger">A processing error occured. This happened because you submitted a website that contains a lot of content and the processing time of MeaningCloud took too long to be processed from the app\'s server.</li>';
